...
import com.inukapulse.user.AppRoleEntity;
import com.inukapulse.user.AppRoleRepository;
 ...
 *
 * Seeds in order:
 *   1. RBAC roles aligned to Inuka Foundation programme domain
 *   2. Inuka cohort sites (dim_site) — needed before ETL can load beneficiary records
 *   3. Default Inuka Foundation user accounts
 *
