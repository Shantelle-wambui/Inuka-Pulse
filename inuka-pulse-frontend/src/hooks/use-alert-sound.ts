...
const STORAGE_KEY = "inuka_alert_sound_muted";
...
export function useAlertSound(): UseAlertSoundResult {
  ...
  // to localStorage, the InukaAlertSound component's instance hears it
  ...
  const toggleMute = useCallback(() => {
    setMuted((prev) => {
      ...
      // trigger setMuted in InukaAlertSound mid-render, which React rejects.
      setTimeout(() => {
