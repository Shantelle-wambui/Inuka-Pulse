...
import { cachedFetchAlerts } from "@/lib/inuka-pulse/cached-fetches";
...
import { InukaAlertSound } from "./_components/inuka-alert-sound";
...
export default async function Layout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    ...
    >
      ...
      <div className="fixed top-0 left-0 right-0 z-[100] h-1 bg-gradient-to-r from-[#00999E] via-[#00999E] to-[#C42152]" />
