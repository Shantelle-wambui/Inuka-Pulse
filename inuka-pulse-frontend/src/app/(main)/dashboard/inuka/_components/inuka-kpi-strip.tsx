...
import type { Alert, DataQualitySummary, SiteRiskSummary } from "@/lib/inuka-pulse/types";

interface InukaKpiStripProps {
  sites: SiteRiskSummary[];
  alerts: Alert[];
  quality: DataQualitySummary;
}

export function InukaKpiStrip({ sites, alerts, quality }: InukaKpiStripProps) {
