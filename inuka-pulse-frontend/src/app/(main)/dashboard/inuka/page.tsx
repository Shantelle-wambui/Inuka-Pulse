...
import { fetchAlerts, fetchBatches, fetchQualitySummary, fetchRiskSummary } from "@/lib/inuka-pulse/api";
...
import { InukaKpiStrip } from "./_components/inuka-kpi-strip";
  ...
  try {
    ...
    return (
      <div className="flex flex-col gap-4">
        ...
        <InukaKpiStrip sites={sites} alerts={alerts} quality={quality} />
