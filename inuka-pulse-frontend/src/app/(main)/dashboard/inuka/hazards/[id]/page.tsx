...
export default async function HazardDetailPage({ params }: PageProps) {
  ...
  if (error) return (
    <div className="flex flex-col gap-4">
      <Button asChild variant="outline" size="icon-sm" className="w-fit"><Link href="/dashboard/inuka/hazards"><ArrowLeft /></Link></Button>
    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        <Button asChild variant="outline" size="icon-sm">
          <Link href="/dashboard/inuka/hazards"><ArrowLeft /></Link>
        </Button>
        <div>
            ...
            {hazard.linkedAlertId && (
              <div className="pt-2 border-t">
                <Button asChild variant="outline" size="sm">
                  <Link href={`/dashboard/inuka/alerts`}>
