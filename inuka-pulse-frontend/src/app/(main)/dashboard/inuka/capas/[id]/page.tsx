...
function getToken() { return document.cookie.match(/inuka-token=([^;]+)/)?.[1]; }
...
export default function CapaDetailPage({ params }: { params: { id: string } }) {
  ...
  if (error) return (
    <div className="flex flex-col gap-4">
      <Button asChild variant="outline" size="icon-sm" className="w-fit"><Link href="/dashboard/inuka/capas"><ArrowLeft /></Link></Button>
    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        <Button asChild variant="outline" size="icon-sm">
          <Link href="/dashboard/inuka/capas"><ArrowLeft /></Link>
        </Button>
        <div>
