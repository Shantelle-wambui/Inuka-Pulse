          ...
          {capas.length === 0 ? (
            ...
            <>
              <div className="divide-y sm:hidden">
                {capas.map((c: any) => (
                  <Link key={c.id} href={`/dashboard/inuka/capas/${c.id}`} className="block px-4 py-3 hover:bg-muted/50">
                    <div className="flex items-center justify-between">
                      ...
                      return (
                        <tr key={c.id} className="group hover:bg-muted/40">
                          ...
                          <td className="px-4 py-3">
                            <Link href={`/dashboard/inuka/capas/${c.id}`} className="opacity-0 group-hover:opacity-100">
